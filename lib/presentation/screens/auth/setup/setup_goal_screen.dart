    ...
    try {
      ...
      if (userId != null) {
        await Supabase.instance.client
            .from('profiles')
            .update({'learning_goal': _selected})
            .eq('id', userId);
      }
      if (mounted) context.push(Routes.setupLevel);
    } catch (e) {
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Ошибка сохранения цели: $e')),
        );
      }
    } finally {
            ...
            Padding(
              ...
              child: SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: _selected == null || _isUpdating ? null : _saveGoal,
